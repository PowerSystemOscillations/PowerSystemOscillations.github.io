...
fig13 = figure;
ax13{1} = subplot(1,1,1,'parent',fig13);
hold(ax13{1},'on');

plot(ax13{1},W_em/(2*pi),[SV_em; cn_em]);
legend(ax13{1},'smx','smn','cn','location','best');

set(ax13{1},'xscale','log');
set(ax13{1},'yscale','log');
axis(ax13{1},[0.01 100 1e-3 1e3]);

xlabel(ax13{1},'Frequency (Hz)');
