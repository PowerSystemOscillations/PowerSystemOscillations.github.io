...
% generator section
gen = tor_mod_con.n_Pe;                       % generator section number
gen_mass = tor_mod_con.M(gen);

% Insert torsional model into SMIB linearized model
A11 = tor.a_mat;
A11(n_mass+gen,gen) = A11(n_mass+gen,gen) + Ks*M/gen_mass;
A11(n_mass+gen,n_mass+gen) = A11(n_mass+gen,n_mass+gen) + Kd*M/gen_mass;

A12 = zeros(2*n_mass,n-2);
A12(n_mass+gen,:) = Pe_row*M/gen_mass;
