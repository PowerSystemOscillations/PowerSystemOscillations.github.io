...
plot(ax19,[0,-5],[0,5*tan(acos(0.05))],'k');
plot(ax19,real(eig_track),imag(eig_track),'bd','markerFaceColor','b','markerSize',3.5);
plot(ax19,real(eig_track(:,1)),imag(eig_track(:,1)),'r+','lineWidth',0.75);
plot(ax19,real(eig_track(:,4)),imag(eig_track(:,4)),'rs','markerSize',8.5);
axis(ax19,[-1,1,0,14]);
