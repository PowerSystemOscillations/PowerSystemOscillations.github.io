...
disp('dc exciters on all generators')
exc_con = [...
...
1 9 0 40. 0.02 0 0 10.  -10.  1.0    .785 3.9267 0.070 5.2356 0.910 0.030 1.0 0 0 0;
1 10 0 40. 0.02 0 0 10.  -10.  1.0    .785 3.9267 0.070 5.2356 0.910 0.030 1.0 0 0 0;
1 11 0 40. 0.02 0 0 10.  -10.  1.0    .785 3.9267 0.070 5.2356 0.910 0.030 1.0 0 0 0;
1 12 0 40. 0.02 0 0 10.  -10.  1.0    .785 3.9267 0.070 5.2356 0.910 0.030 1.0 0 0 0;
1 13 0 40. 0.02 0 0 10.  -10.  1.0    .785 3.9267 0.070 5.2356 0.910 0.030 1.0 0 0 0;
1 14 0 40. 0.02 0 0 10.  -10.  1.0    .785 3.9267 0.070 5.2356 0.910 0.030 1.0 0 0 0;
1 15 0 40. 0.02 0 0 10.  -10.  1.0    .785 3.9267 0.070 5.2356 0.910 0.030 1.0 0 0 0;
1 16 0 40. 0.02 0 0 10.  -10.  1.0    .785 3.9267 0.070 5.2356 0.910 0.030 1.0 0 0 0];



% hydro governor model
% tg_con matrix format (at generators 1:12)
%column	       data			unit
...
% tg_con matrix format (at generators 13 to 16)
%column	       data			unit
...
disp('active loads 50/50 constant current/constant impedance; reactive loads constant impedance')
load_con = [...
1  0 0 .5 0;
3  0 0 .5 0;
4  0 0 .5 0;
