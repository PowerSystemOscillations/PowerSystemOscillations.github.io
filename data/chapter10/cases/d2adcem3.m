...
% 100 MVA SVC at bus 3
% One line in service between bus 3 and bus 101 and bus 13 and 101
...
bus = [...
	...
	3  1.0      -6.1    0.00   0.50  0.00  0.00  0.00  3.50 2   0.0   0.0  230.0  1.5  .5;%3.5 MVA capacitors
	...
	12 1.01    -16.9    7.00   1.39  0.00  0.00  0.00  0.00 2   5.0  -2.0  22.0   1.1  .9;%5 MVA capacitors
...
line = [...
1   10  0.0     0.0167   0.00    1.0  0. 0.  0.  0.;%1
2   20  0.0     0.0167   0.00    1.0  0. 0.  0.  0.;%2
3    4  0.0     0.005     0.00   1.0  0. 1.2 0.8 0.05;%3
3   20  0.001   0.0100   0.0175  1.0  0. 0.  0.  0.;%4
3   101 0.011   0.110    0.1925  1.0  0. 0.  0.  0.;%5
%3   101 0.011   0.110    0.1925  1.0  0. 0.  0.  0.;
10  20  0.0025  0.025    0.0437  1.0  0. 0.  0.  0.;%6
11  110 0.0     0.0167   0.0     1.0  0. 0.  0.  0.;%7
12  120 0.0     0.0167   0.0     1.0  0. 0.  0.  0.;%8
13   14 0.0     0.005    0.00    1.0  0. 1.2 0.8 0.05;%9
%13  101 0.011   0.11     0.1925  1.0  0. 0.  0.  0.;%10
13  101 0.011   0.11     0.1925  1.0  0. 0.  0.  0.;%11
13  120 0.001   0.01     0.0175  1.0  0. 0.  0.  0.;%12
...
4    0  0   .5  0;
14   0  0   .5  0];
disp('0.5 constant current load, reactive load modulation at buses 4 and 14')
...
svc_con = [1  3  100  1  -1  10  0.05];
%user defined control cell element definitions
% svc_dc(jj,1) - control state space object
% svc_dc{jj,2} - svc number
% svc_dc{jj,3} - line number for current magnitude input to controller
% svc_dc{jj,4} - maximum output limit
% svc_dc{jj,5} - minimum output limit
% svc_dc{jj,6} - number of control states
wd = cd;
cdps('chapter10\results')
load control
svc_dc{1,1}=5.*sc2.*scr2;
svc_dc{1,2}=1;svc_dc{1,3}=5;svc_dc{1,4}=.1;svc_dc{1,5}=-.1;svc_dc{1,6}=18;
cd(wd)
...
0.1  3   101  0    0    0     0.005; %3ph fault at bus 3, on line 3-101
