...
bus = [...
  ...
  102  1.0     -10    0.00   0.00  1.09  0.36  0.00  0.00 3  99.0  -99.0  110.0  1.2  .5;
  ...
  103  1.0     -14    0.00   0.00  -1.1  0.609 0.00  1.00 3  99.0  -99.0  110.0  1.2  .5; 
...
dci_dc=[];
%dcr_dc=[];
dcr_dc{1}=-2.*wo_stsp(1).*ldlg_stsp(1,.02,.1).*ldlg_stsp(1,.02,.1);dcr_dc{2}=1;dcr_dc{3}=3;dcr_dc{4}=3;
dcr_dc{5}=.5;dcr_dc{6}=-.5;dcr_dc{7}=3;
