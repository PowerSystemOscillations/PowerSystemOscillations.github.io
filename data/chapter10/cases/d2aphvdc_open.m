...
bus = [...
  ...
  102  1.0     -10    0.00   0.00  1.09  .36   0.00  0.00 3  99.0   -99.0 110.0  1.2  .5;
  ...
  103  1.0     -14    0.00   0.00  -1.1 .609  0.00  1.00 3  99.0  -99.0  110.0   1.2  .5;
...
3   102 0.0     0.01    0.00    1.0  0. 5.0 0.5 0.005;
...
disp('HVDC line between buses 102 and 103')
...
dcsp_con = [...
1  102  1  500  3    4   5   30;
2  103  2  500  3    4  18   25];
...
% static exciter on gen 2, dc exciters on gens 1,3 and 4, no pss
...
4   0  0   .5  0;
14  0  0   .5  0;
102 0  0   0   0;% dc rectifier bus
103 0  0   0   0];% dc inverter bus
...
% no user-defined damping control
dci_dc=[];
dcr_dc=[];

% user-defined damping control
% load('../mat/dcpf1cont2.mat');
%
% sys_crmp = ss(s_crmp.a,s_crmp.b,s_crmp.c,s_crmp.d);
% dcr_dc{1} = -3*dif_stsp(0.01)*wo_stsp(.1)*sys_crmp;
% dcr_dc{2} = 1;
% dcr_dc{3} = 3;
% dcr_dc{4} = 13;
% dcr_dc{5} = 1;
...
0.1    3    101    1.0    1.0     1    0.005; %line-to-ground fault bus 3 line 3-101
