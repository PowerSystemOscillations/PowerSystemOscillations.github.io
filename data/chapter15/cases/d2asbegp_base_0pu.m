...
tmp_gc1 = [ 1   91  my_Rg 1.0  0.0  0.01   0.1    1    0.05 1.0  -1.0;
            2  911  my_Rg 1.0  0.0  0.01   0.1    1    0.05 1.0  -1.0;
            3  915  my_Rg 1.0  0.0  0.01   0.1    1    0.05 1.0  -1.0];

%          kpv kiv   T_E kpqmax kiqmax qawf Emax Emin Imax Tpf  Tqf  Tvf  qvflag vflag sflag
tmp_gc2 = [0.0 40.0  0.0 3.0    20.0    1   1.15 0.0  1.2  0.02 0.02 0.02 0      0     0;
           0.0 40.0  0.0 3.0    20.0    1   1.15 0.0  1.2  0.02 0.02 0.02 0      0     0;
           0.0 40.0  0.0 3.0    20.0    1   1.15 0.0  1.2  0.02 0.02 0.02 0      0     0];
